...
namespace CharTestApp
{
    public partial class ChartForm : MetroForm
    {
        ...
        private void BtnDataBind_Click(object sender, EventArgs e)
        {
            ...
            students.Add(new Student("이채은", 63.3));
            students.Add(new Student("여예지", 58.4));
            students.Add(new Student("김민수", 80.4));
            students.Add(new Student("오동욱", 10.4));
            students.Add(new Student("김희지", 20.4));
        ...
        private void BtnMultiChar_Click(object sender, EventArgs e)
        {
            ...
            chart1.Series["series2"].Points.AddXY(5, 950);

            chart1.Series["series3"].Points.AddXY(1, 220);
            chart1.Series["series3"].Points.AddXY(2, 330);
            chart1.Series["series3"].Points.AddXY(3, 440);
            chart1.Series["series3"].Points.AddXY(4, 880);
            chart1.Series["series3"].Points.AddXY(5, 770);
        ...
        private void BntDBBind_Click(object sender, EventArgs e)
        {
            using (MySqlConnection conn = new MySqlConnection(strConnstring))
            {
                ...
                chart1.Series[0].Color = Color.Violet;
